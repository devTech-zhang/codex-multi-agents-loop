...
DEFAULT_CONFIG_TEMPLATE: dict[str, Any] = {
    "storage": {
        "home": ".codex-delivery-workflow",
        "db": ".codex-delivery-workflow/workflow.db",
        "artifact_root": "delivery-artifacts",
        "source_root": "delivery-workspace",
        "logs": ".codex-delivery-workflow/logs",
    },
    "workflow": {
        "auto_start": True,
        "auto_run_to_idle": True,
        "max_auto_jobs": 20,
...
def initialize_project_workspace(*, overwrite_config: bool = False) -> dict[str, Any]:
    ...
    log_workflow("project_workspace.init.started", "开始初始化当前 Codex 交付工作流工作区。", payload={"overwrite_config": overwrite_config})
...
def detect_platform() -> str:
    """Auto-detect Codex CLI for the slim workflow."""
